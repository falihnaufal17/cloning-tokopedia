    ...
    return (
      <div>
        <div class="tabset">
          ...
          <label style={{ width: '170px', fontWeight: '500' }} for="tab1">Informasi Produk</label>

          <input type="radio" name="tabset" id="tab2" aria-controls="rauchbier"></input>
          <label style={{ width: '170px', fontWeight: '500' }} for="tab2">Ulasan</label>

          <input type="radio" name="tabset" id="tab3" aria-controls="dunkles"></input>
          <label style={{ width: '170px', fontWeight: '500' }} for="tab3">Diskusi Produk</label>
          ...
          <div class="tab-panels mt-3">
            <section id="marzen" class="tab-panel" style={{ marginLeft: '13px' }}>
              <h2 style={{ marginTop: '-20px' }}>6A. Informasi Produk</h2>
            ...
            <section id="rauchbier" class="tab-panel" style={{ marginLeft: '13px' }}>
              <h2 style={{ marginTop: '-20px' }}>6B. Ulasan</h2>
            ...
            <section id="dunkles" class="tab-panel" style={{ marginLeft: '13px' }}>
              <h2 style={{ marginTop: '-20px' }}>6C. Diskusi Produk</h2>
